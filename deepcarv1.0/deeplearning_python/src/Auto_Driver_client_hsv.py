...
# recog classes
classes = 6
label_dict = {0:"n/limit",1:"limit",2:"stop",3:"red",4:"green",5:"zebra"}
DEBUG_MODE = False
...
def process_frame(img,labels,scores,boxes):
    ...
    for label, box,score in zip(labels,boxes,scores):
        ...
        d = cv2.putText(img, label_dict[int(label)]+":"+str(score), (int(box[0]*x_rate), int(box[1]*y_rate)), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 1)
    return d   
