...
def save_image_process(lock,n,status,start,Camera,data):
...
if __name__ == '__main__':
    ...
    try:
        ...
        process_image = multiprocessing.Process(target=save_image_process,args=(lock,Flag_save_data,Status,START,camera,Speed))
